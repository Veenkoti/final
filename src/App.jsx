  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-4 text-white">
      ...
      <div className="absolute top-4 right-4 z-10">
        <Button onClick={() => setLanternMode(!lanternMode)}>
      ...
      <div className="relative z-10 max-w-xl w-full space-y-6">
        ...
        <Card className="shadow-xl bg-white bg-opacity-10 backdrop-blur-md">
          <CardContent className="p-6 space-y-4">
            <p className="text-lg text-white">{prompt || "Click below to receive a journal prompt."}</p>
            <Button onClick={generatePrompt} className="w-full">Generate Prompt</Button>
            <textarea
              ref={textAreaRef}
              value={entry}
            ...
            <div className="flex gap-2">
              <Button onClick={copyToClipboard} className="w-full">Copy</Button>
              <Button onClick={downloadEntry} className="w-full">Download</Button>
            </div>
          </CardContent>
        </Card>
